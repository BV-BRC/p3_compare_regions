module SEED
{
    ...
    funcdef get_dna_seq(list<feature_id> fids) returns (mapping<feature_id, string> seqs);
    ...
    funcdef all_subsystems() returns (list<string> subsystem_names);
    funcdef get_subsystem_roles(list<string> subsystems) returns (list<tuple<string ss_name, list<string>>> roles);
};
